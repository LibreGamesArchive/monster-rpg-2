...
class MySwitchOutReceiver extends BroadcastReceiver
{
   ...
   {
      Log.d("Allegro", "In MySwitchOutReceiver");
      AllegroActivity aa = (AllegroActivity)context;
      aa.nativeSendSwitchOutEvent();
      Log.d("Allegro", "MySwitchOutReceiver end");
   }
}

class MySwitchInReceiver extends BroadcastReceiver
{
   public void onReceive(Context context, Intent intent)
   {
      Log.d("Allegro", "In MySwitchInReceiver");
      AllegroActivity aa = (AllegroActivity)context;
      aa.nativeSendSwitchInEvent();
      Log.d("Allegro", "MySwitchInReceiver end");
   }
}
...
public class AllegroActivity extends Activity implements SensorEventListener
{
   ...
   MySwitchOutReceiver switchOutReceiver;
   MySwitchInReceiver switchInReceiver;
   ...
   public native void nativeSendSwitchOutEvent();
   public native void nativeSendSwitchInEvent();
   ...
   public void onCreate(Bundle savedInstanceState)
   {
      ...
      switchOutReceiver = new MySwitchOutReceiver();
      switchInReceiver = new MySwitchInReceiver();
      registerReceiver(switchOutReceiver,
         new IntentFilter(Intent.ACTION_SCREEN_OFF));
      registerReceiver(switchInReceiver,
   ...
   public void onPause()
   {
      ...
      //wasFullPause = powerManager.isScreenOn();

   /*
      if (!wasFullPause) {
         Log.d("AllegroActivity", "onPause: locked");
         return;
      }
   */
   ...
   public void onResume()
   {
      ...
      /*
      if (!wasFullPause) {
         Log.d("AllegroActivity", "onResume: unlocking");
         return;
      }
      */
