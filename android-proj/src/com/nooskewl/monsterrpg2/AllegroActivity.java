...
public class AllegroActivity extends ZeemoteActivity implements SensorEventListener, IStatusListener, IJoystickListener, IButtonListener
{
   /* properties */
   ...
   // zeemote stuff
   public native void nativeZeemoteConnect();
   public native void nativeZeemoteDisconnect();
   ...
   public void onCreate(Bundle savedInstanceState)
   {
      ...
      if (true) {//!android.os.Build.VERSION.RELEASE.substring(0, 3).equals("2.2")) {
   ...
   public void connected(ControllerEvent event) {
      //com.zeemote.zc.config = event.getController().getConfiguration();
      nativeZeemoteConnect();
   }
   ...
   public void joystickMoved(JoystickEvent e) {
      ...
      float x = e.getScaledX(-100, 100) / 100.0f;
      float y = e.getScaledY(-100, 100) / 100.0f;
      nativeZeemoteAxis(x, y);
   }

   private int get_button(int button)
   {
      int n = 0;
      switch (button) {
         case ButtonEvent.BUTTON_A:
            n = 0;
            break;
         case ButtonEvent.BUTTON_B:
            n = 1;
            break;
         case ButtonEvent.BUTTON_C:
            n = 2;
            break;
         case ButtonEvent.BUTTON_D:
            n = 3;
            break;
      }
      return n;
   ...
   public void buttonPressed(ButtonEvent e) {
      ...
      int button = e.getButtonGameAction();
      int n = get_button(button);
      nativeZeemoteButtonDown(n);
   }
   ...
   public void buttonReleased(ButtonEvent e) {
      ...
      int button = e.getButtonGameAction();
      int n = get_button(button);
      nativeZeemoteButtonUp(n);
   }
      
   public void find_zeemotes()
   {
   ...
   public void autoconnect_zeemote()
   {
