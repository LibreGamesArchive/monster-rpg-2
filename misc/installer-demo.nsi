...
!define Game "Monster RPG 2 Demo"
!define ExeName "MonsterRPG2Demo"
...
!else
  ...
  !system "$\"${NSISDIR}\makensis$\" /DINNER C:\Users\Trent\code\monster-rpg-2\installer-demo.nsi" = 0
...
;Pages
  ...
  !insertmacro MUI_PAGE_LICENSE "docs\FreewareLicense.txt"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\FreewareLicense.txt"
